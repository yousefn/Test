...
const swashContract = artifacts.require('SWASH.sol');
const MockRecipientNotERC677Contract = artifacts.require('MockRecipientNotERC677Receiver.sol');
const MockRecipientContract = artifacts.require('MockRecipient.sol');
const MockRecipientReturnBoolContract = artifacts.require('MockRecipientReturnBool.sol');
let accounts;
let _swash;
